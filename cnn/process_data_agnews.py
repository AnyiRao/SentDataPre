...
train_fn = 'data/ag_news_csv/train.csv'
test_fn = 'data/ag_news_csv/test.csv'
...
def build_data_cv(clean_string=True):
    ...
    test_x, test_y = read_csv(test_fn)
...
if __name__ == '__main__':
    process_data("data/processed/ag_news.p")
    x = cPickle.load(open("data/processed/ag_news.p","rb"))
